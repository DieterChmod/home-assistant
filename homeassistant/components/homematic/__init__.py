...
HM_DEVICE_TYPES = {
    ...
    DISCOVER_SENSORS: [
        ...
        'IPThermostatWall2', 'IPSmoke', 'RFSiren', 'PresenceIP',
        'IPAreaThermostat', 'IPWeatherSensor', 'RotaryHandleSensorIP',
        'IPPassageSensor', 'IPKeySwitchPowermeter', 'IPThermostatWall230V',
        'IPWeatherSensorPlus', 'IPWeatherSensorBasic', 'IPBrightnessSensor',
        'IPGarage', 'UniversalSensor', 'MotionIPV2', 'IPMultiIO'],
    DISCOVER_CLIMATE: [
        'Thermostat', 'ThermostatWall', 'MAXThermostat', 'ThermostatWall2',
        'MAXWallThermostat', 'IPThermostat', 'IPThermostatWall',
        'IPThermostatWall2', 'ThermostatGroup', 'IPThermostatWall230V'],
...
class HMDevice(Entity):
    ...
    def _hm_event_callback(self, device, caller, attribute, value):
        ...
        _LOGGER.debug("%s received event '%s' value: %s", self._name,
                      attribute, value)
        if (int(device.split(':')[-1]) != int(self._channel)) and (self._hmdevice.TYPE == "HM-Sen-RD-O"):
            return
